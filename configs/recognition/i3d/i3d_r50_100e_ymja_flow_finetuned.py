...
ann_file_train = 'data/YMJA/ymja_train_split_1_rawframes.txt'
ann_file_val = 'data/YMJA/ymja_val_split_1_rawframes.txt'
ann_file_test = 'data/YMJA/ymja_test_split_1_rawframes.txt'
img_norm_cfg = dict(
...
evaluation = dict(
    interval=5, metrics=['top_k_accuracy', 'mean_class_accuracy']) #interval =1
log_config = dict(
    interval=5, 
    hooks=[
...
log_level = 'INFO'
work_dir = './work_dirs/i3d_r50_100e_ymja_flow_finetuned.py/'
