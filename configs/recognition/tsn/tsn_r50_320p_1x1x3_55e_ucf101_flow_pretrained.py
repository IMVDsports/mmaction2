...
img_norm_cfg = dict(
    mean=[128, 128], std=[58, 57], to_bgr=False)
train_pipeline = [
...
# learning policy
lr_config = dict(policy='step', step=[35, 50])
total_epochs = 55
...
load_from = 'https://download.openmmlab.com/mmaction/recognition/tsn/tsn_r50_320p_1x1x3_110e_kinetics400_flow/tsn_r50_320p_1x1x3_110e_kinetics400_flow_20200705-3036bab6.pth'
resume_from = None
workflow = [('train', 1)]
